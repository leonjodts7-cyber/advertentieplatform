...
export default async function AdvertentieDetailPage({
  ...
  const contactKnop = advertentie.telefoon ? (
    ...
    <p className="rounded-xl border border-white/12 bg-white/[0.05] px-4 py-3 text-center text-sm text-muted-foreground">
    ...
    <div className="pb-24 lg:pb-10">
      ...
      <div className="container">
        <div className="relative overflow-hidden rounded-2xl border border-white/12">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[var(--background)]/90 via-[var(--background)]/20 to-transparent pointer-events-none" />
      ...
      <div className="container mt-6 lg:mt-8">
        <div className="lg:grid lg:grid-cols-3 lg:gap-8">
          <article className="lg:col-span-2">
            <div className="profile-card p-5 sm:p-7">
